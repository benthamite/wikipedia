...
The default review prompts instruct the AI to distinguish article prose
changes from routine markup or metadata updates (citation dates, URLs,
wikilink formatting, template parameters), scoring the latter low.
...
The minor mode ~wikipedia-edit-mode~ provides additional keybindings when
editing a wiki page.  It displays =WP= in the mode line lighter and
...
- *Page*: open, publish, preview, browse, and login.
