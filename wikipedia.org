...
The package requires Emacs 29.1 or later, =mediawiki.el= for the
underlying API communication, and =pangram.el= for AI-generated text
detection.  Before using any commands, you must configure at least one
...
- *Sync & Mirror*: sync page, sync watchlist, sync update, and mirror
  browser.
- *AI Detection*: detect AI-generated text and clear overlays (via
  =pangram.el=).
